...
public class C03_ListeTopluElemanEkleme {
    ...
    public static void main(String[] args) {
        ...
        int [] arr={2,3,4,5,3,6,7,3,8,9,1,2,5,3,8,5};//bunları tek tek add komutu ile eklemek yerine onları for loop
        //ile ekleyebiliraz once onları bir array'e ekleriz.
