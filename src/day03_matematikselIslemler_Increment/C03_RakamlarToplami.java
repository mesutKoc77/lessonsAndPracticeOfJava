...
public class C03_RakamlarToplami {
    public static void main(String[] args) {
        ...
        // önce birler basamağı bul, rakamlar toplamına ekle ve birler basamağından kurtul.

        /*
        javada koda yazmadan once once ihtiyacları tespit edip ondan sonra buna göre vaiable oluşturmalı.
        şimdi o adımlar:
        önce birler basamağı variable ı
        sonra rakamlar toplamı variable ı oluşturacagz.
        daha sonra o birler basamapından kurtulup diğer sayının birler basamağı ve rak. topl. bulaccagız.
         */
